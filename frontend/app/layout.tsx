  ...
  "@graph": [
    {
      ...
      name: "CareerNavIQ",
      url: SITE_URL,
      logo: `${SITE_URL}/careernaviq-logo.png?v=20260810r`,
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: SITE_DESCRIPTION,
    images: [{ url: "/careernaviq-logo.png?v=20260810r", width: 1227, height: 223, alt: "CareerNavIQ" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "CareerNavIQ | Executive Career Intelligence",
    description: SITE_DESCRIPTION,
    images: ["/careernaviq-logo.png?v=20260810r"],
  },
  robots: {
    index: true,
    follow: true,
